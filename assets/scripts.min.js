function focusEl(t) {
    $("label #" + t.target.id).siblings(".placeholder").hide(), $("label #" + t.target.id).blur(function() {
        "" === $("label #" + t.target.id).val() && $("label #" + t.target.id).siblings(".placeholder").show()
    })
}! function(t, e) {
    "use strict";
    ...
    function _(t) {
        var e = !!t && "length" in t && t.length,
            n = v.type(t);
        return "function" !== n && !v.isWindow(t) && ("array" === n || 0 === e || "number" == typeof e && 0 < e && e - 1 in t)
    }
    v.fn = v.prototype = {
        jquery: m,
        constructor: v,
        ...
        camelCase: function(t) {
            return t.replace(w, "ms-").replace(x, b)
        },
        ...
        proxy: function(t, e) {
            var n, i, r;
            if ("string" == typeof e && (n = t[e], e = t, t = n), v.isFunction(t)) return i = o.call(arguments, 2), (r = function() {
    ...
    var C = function(t) {
        var e, n, i, r, o, s, a, l, c, u, h, p, d, f, g, m, v, y, w, x = "sizzle" + 1 * new Date,
            b = t.document,
            _ = 0,
            C = 0,
            T = st(),
        ...
        try {
            A.apply(D = L.call(b.childNodes), b.childNodes), D[b.childNodes.length].nodeType
        } catch (e) {
            A = {
            ...
            if (!r && ((e ? e.ownerDocument || e : b) !== d && p(e), e = e || d, g)) {
                if (11 !== _ && (h = Z.exec(t)))
                    if (o = h[1]) {
                        ...
                        if ((o = h[3]) && n.getElementsByClassName && e.getElementsByClassName) return A.apply(i, e.getElementsByClassName(o)), i
        ...
        for (e in n = ot.support = {}, o = ot.isXML = function(t) {
                ...
                return s !== d && 9 === s.nodeType && s.documentElement && (f = (d = s).documentElement, g = !o(d), b !== d && (r = d.defaultView) && r.top !== r && (r.addEventListener ? r.addEventListener("unload", it, !1) : r.attachEvent && r.attachEvent("onunload", it)), n.attributes = lt(function(t) {
                    ...
                    n.disconnectedMatch = y.call(t, "*"), y.call(t, "[s!='']:x"), v.push("!=", P)
                    ...
                    var n, i = 0,
                        ...
                        s = [t],
                        a = [e];
                    if (!r || !o) return t === d ? -1 : e === d ? 1 : r ? -1 : o ? 1 : u ? q(u, t) - q(u, e) : 0;
                ...
                if ((t.ownerDocument || t) !== d && p(t), e = e.replace(B, "='$1']"), n.matchesSelector && g && !$[e + " "] && (!v || !v.test(e)) && (!m || !m.test(e))) try {
                    var i = y.call(t, e);
                    if (i || n.disconnectedMatch || t.document && 11 !== t.document.nodeType) return i
                } catch (t) {}
                return 0 < ot(e, d, null, [t]).length
            }, ot.contains = function(t, e) {
                return (t.ownerDocument || t) !== d && p(t), w(t, e)
            }, ot.attr = function(t, e) {
                (t.ownerDocument || t) !== d && p(t);
                var r = i.attrHandle[e.toLowerCase()],
                    o = r && S.call(i.attrHandle, e.toLowerCase()) ? r(t, e, !g) : void 0;
                ...
                preFilter: {
                    ...
                    PSEUDO: function(t) {
                        var e, n = !t[6] && t[2];
                        return U.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && V.test(n) && (e = s(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(t) {
                    ...
                    ATTR: function(t, e, n) {
                        return function(i) {
                            var r = ot.attr(i, t);
                            return null == r ? "!=" === e : !e || (r += "", "=" === e ? r === n : "!=" === e ? r !== n : "^=" === e ? n && 0 === r.indexOf(n) : "*=" === e ? n && -1 < r.indexOf(n) : "$=" === e ? n && r.slice(-n.length) === n : "~=" === e ? -1 < (" " + r.replace(M, " ") + " ").indexOf(n) : "|=" === e && (r === n || r.slice(0, n.length + 1) === n + "-"))
                        }
                    },
                    ...
                    PSEUDO: function(t, e) {
                        ...
                        return r[x] ? r(e) : 1 < r.length ? (n = [t, t, "", e], i.setFilters.hasOwnProperty(t.toLowerCase()) ? at(function(t, n) {
                            for (var i, o = r(t, e), s = o.length; s--;) t[i = q(t, o[s])] = !(n[i] = o[s])
                        }) : function(t) {
                            return r(t, 0, n)
                        }) : r
                    }
                ...
                pseudos: {
                    ...
                    lang: at(function(t) {
                        return X.test(t || "") || ot.error("unsupported lang: " + t), t = t.replace(K, tt).toLowerCase(),
                            function(e) {
                                var n;
                                do {
        ...
        function bt(t, e, n, i, r, o) {
            return i && !i[x] && (i = bt(i)), r && !r[x] && (r = bt(r, o)), at(function(o, s, a, l) {
                var c, u, h, p = [],
                    d = [],
                    f = s.length,
                    g = o || function(t, e, n) {
                ...
                if (o) {
                    if (r || t) {
                        ...
                        for (u = v.length; u--;)(h = v[u]) && -1 < (c = r ? q(o, h) : p[u]) && (o[c] = !(s[c] = h))
                    }
                } else v = xt(v === s ? v.splice(f, v.length) : v), r ? r(null, s, v, l) : A.apply(s, v)
            })
        }
            ...
            for (var e, n, r, o = t.length, s = i.relative[t[0].type], a = s || i.relative[" "], l = s ? 1 : 0, u = yt(function(t) {
                ...
                if (n = i.relative[t[l].type]) p = [yt(wt(p), n)];
                    ...
                    if ((n = i.filter[t[l].type].apply(null, t[l].matches))[x]) {
                        ...
                        return bt(1 < l && wt(p), 1 < l && vt(t.slice(0, l - 1).concat({
                            value: " " === t[l - 2].type ? "*" : ""
                        })).replace(I, "$1"), n, l < r && _t(t.slice(l, r)), r < o && _t(t = t.slice(r)), r < o && vt(t))
                    }
                    p.push(n)
                } return wt(p)
        }
        return mt.prototype = i.filters = i.pseudos, i.setFilters = new mt, s = ot.tokenize = function(t, e) {
            ...
            var n, r, o, a, l, u, h = [],
                ...
                m = $[t + " "];
            if (!m) {
                for (e || (e = s(t)), n = e.length; n--;)(m = _t(e[n]))[x] ? h.push(m) : f.push(m);
                (m = $(t, (r = f, a = 0 < (o = h).length, l = 0 < r.length, u = function(t, e, n, s, u) {
                    var h, f, m, v = 0,
                        y = "0",
                        w = t && [],
                        x = [],
                        ...
                        k = C.length;
                    for (u && (c = e === d || e || u); y !== k && null != (h = C[y]); y++) {
                        if (l && h) {
                        ...
                        a && ((h = !m && h) && v--, t && w.push(h))
                    }
                    if (v += y, a && y !== v) {
                        for (f = 0; m = o[f++];) m(w, x, e, n);
                        if (t) {
                            if (0 < v)
                                for (; y--;) w[y] || x[y] || (x[y] = j.call(s));
                            x = xt(x)
                        }
                        A.apply(s, x), u && !t && 0 < x.length && 1 < v + o.length && ot.uniqueSort(s)
                    }
                    return u && (_ = T, c = b), w
                }, a ? at(u) : u))).selector = t
            }
            ...
            var o, l, c, u, h, p = "function" == typeof t && t,
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (o = U.needsContext.test(t) ? 0 : l.length; o-- && (c = l[o], !i.relative[u = c.type]);)
        ...
        }, n.sortStable = x.split("").sort(E).join("") === x, n.detectDuplicates = !!h, p(), n.sortDetached = lt(function(t) {
    ...
    function D(t, e, n) {
        ...
        }) : S.test(e) ? v.filter(e, t, n) : (e = v.filter(e, t), v.grep(t, function(t) {
            return -1 < l.call(e, t) !== n && 1 === t.nodeType
        }))
    }
    v.filter = function(t, e, n) {
        ...
        is: function(t) {
            return !!D(this, "string" == typeof t && $.test(t) ? v(t) : t || [], !1).length
        }
    });
    var j, N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (v.fn.init = function(t, e, n) {
        ...
        if (n = n || j, "string" == typeof t) {
            ...
            if (r[1]) {
                if (e = e instanceof v ? e[0] : e, v.merge(this, v.parseHTML(r[1], e && e.nodeType ? e.ownerDocument || e : i, !0)), E.test(r[1]) && v.isPlainObject(e))
    ...
    v.fn.extend({
            ...
            if (!$.test(t))
                for (; i < r; i++)
                    for (n = this[i]; n && n !== e; n = n.parentNode)
                        if (n.nodeType < 11 && (s ? -1 < s.index(n) : 1 === n.nodeType && v.find.matchesSelector(n, t))) {
                            o.push(n);
                            break
        ...
        v.fn[t] = function(n, i) {
            ...
            return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (r = v.filter(i, r)), 1 < this.length && (L[t] || v.uniqueSort(r), A.test(t) && r.reverse()), this.pushStack(r)
        }
    });
    var z = /[^\x20\t\r\n\f]+/g;
    ...
    v.Callbacks = function(t) {
        var e, n;
        t = "string" == typeof t ? (e = t, n = {}, v.each(e.match(z) || [], function(t, e) {
            n[e] = !0
        }), n) : v.extend({}, t);
        var i, r, o, s, a = [],
            l = [],
            c = -1,
            u = function() {
                for (s = t.once, o = i = !0; l.length; c = -1)
                ...
                add: function() {
                    return a && (r && !i && (c = a.length - 1, l.push(r)), function e(n) {
                        v.each(n, function(n, i) {
                            v.isFunction(i) ? t.unique && h.has(i) || a.push(i) : i && i.length && "string" !== v.type(i) && e(i)
                        })
                    }(arguments), r && !i && u()), this
                },
                remove: function() {
                    return v.each(arguments, function(t, e) {
                        for (var n; - 1 < (n = v.inArray(e, a, n));) a.splice(n, 1), n <= c && c--
                    }), this
                },
                has: function(t) {
                    return t ? -1 < v.inArray(t, a) : 0 < a.length
                },
                empty: function() {
                    return a && (a = []), this
                },
                ...
                r = {
                    ...
                    then: function(e, i, r) {
                                ...
                                var a = this,
                                    ...
                                    c = function() {
                                        ...
                                        if (!(e < o)) {
                                            ...
                                            c = t && ("object" == typeof t || "function" == typeof t) && t.then, v.isFunction(c) ? r ? c.call(t, s(o, n, H, r), s(o, n, F, r)) : (o++, c.call(t, s(o, n, H, r), s(o, n, F, r), s(o, n, H, n.notifyWith))) : (i !== H && (a = void 0, l = [t]), (r || n.resolveWith)(a, l))
                                        }
                                    },
                                    u = r ? c : function() {
                                        try {
                                            ...
                                            v.Deferred.exceptionHook && v.Deferred.exceptionHook(t, u.stackTrace), o <= e + 1 && (i !== F && (a = void 0, l = [t]), n.rejectWith(a, l))
                                        }
                                    };
                        ...
                        return v.Deferred(function(t) {
                            n[0][3].add(s(0, t, v.isFunction(r) ? r : H, t.notifyWith)), n[1][3].add(s(0, t, v.isFunction(e) ? e : H)), n[2][3].add(s(0, t, v.isFunction(i) ? i : F))
                        }).promise()
                    },
                    promise: function(t) {
        ...
        when: function(t) {
            ...
            if (e <= 1 && (O(t, s.done(a(n)).resolve, s.reject), "pending" === s.state() || v.isFunction(r[n] && r[n].then))) return s.then();
    ...
    function I() {
        i.removeEventListener("DOMContentLoaded", I), t.removeEventListener("load", I), v.ready()
    }
    v.fn.ready = function(t) {
        ...
        ready: function(t) {
            (!0 === t ? --v.readyWait : v.isReady) || (v.isReady = !0) !== t && 0 < --v.readyWait || M.resolveWith(i, [v])
        }
    }), v.ready.then = M.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? t.setTimeout(v.ready) : (i.addEventListener("DOMContentLoaded", I), t.addEventListener("load", I));
    ...
    B.uid = 1, B.prototype = {
        ...
        set: function(t, e, n) {
            ...
            if ("string" == typeof e) r[v.camelCase(e)] = n;
                ...
                for (i in e) r[v.camelCase(i)] = e[i];
            return r
        },
        get: function(t, e) {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== i) {
                if (void 0 !== e) {
                    n = (e = v.isArray(e) ? e.map(v.camelCase) : (e = v.camelCase(e)) in i ? [e] : e.match(z) || []).length;
                    for (; n--;) delete i[e[n]]
    ...
    v.extend({
        ...
        queue: function(t, e, n) {
            var i;
            if (t) return e = (e || "fx") + "queue", i = V.get(t, e), n && (!i || v.isArray(n) ? i = V.access(t, e, v.makeArray(n)) : i.push(n)), i || []
        },
    ...
    function et(t, e, n, i) {
        ...
        if (u && u[3] !== c)
            for (c = c || u[3], n = n || [], u = +l || 1; u /= o = o || ".5", v.style(t, e, u + c), o !== (o = a() / l) && 1 !== o && --s;);
        return n && (u = +u || +l || 0, r = n[1] ? u + (n[1] + 1) * n[2] : +n[2], i && (i.unit = c, i.start = u, i.end = r)), r
    }
    var nt = {};

    function it(t, e) {
        for (var n, i, r = [], o = 0, s = t.length; o < s; o++)(i = t[o]).style && (n = i.style.display, e ? ("none" === n && (r[o] = V.get(i, "display") || null, r[o] || (i.style.display = "")), "" === i.style.display && K(i) && (r[o] = (h = c = l = void 0, c = (a = i).ownerDocument, u = a.nodeName, (h = nt[u]) || (l = c.body.appendChild(c.createElement(u)), h = v.css(l, "display"), l.parentNode.removeChild(l), "none" === h && (h = "block"), nt[u] = h)))) : "none" !== n && (r[o] = "none", V.set(i, "display", n)));
        var a, l, c, u, h;
    ...
    function dt(t, e, n, i, r) {
        for (var o, s, a, l, c, u, h = e.createDocumentFragment(), p = [], d = 0, f = t.length; d < f; d++)
            ...
            for (s = s || h.appendChild(e.createElement("div")), a = (ot.exec(o) || ["", ""])[1].toLowerCase(), l = at[a] || at._default, s.innerHTML = l[1] + v.htmlPrefilter(o) + l[2], u = l[0]; u--;) s = s.lastChild;
            v.merge(p, s.childNodes), (s = h.firstChild).textContent = ""
        } else p.push(e.createTextNode(o));
        for (h.textContent = "", d = 0; o = p[d++];)
            if (i && -1 < v.inArray(o, i)) r && r.push(o);
            else if (c = v.contains(o.ownerDocument, o), s = lt(h.appendChild(o), "script"), c && ct(s), n)
            for (u = 0; o = s[u++];) st.test(o.type || "") && n.push(o);
        return h
    }
    ut = i.createDocumentFragment().appendChild(i.createElement("div")), (ht = i.createElement("input")).setAttribute("type", "radio"), ht.setAttribute("checked", "checked"), ht.setAttribute("name", "t"), ut.appendChild(ht), f.checkClone = ut.cloneNode(!0).cloneNode(!0).lastChild.checked, ut.innerHTML = "<textarea>x</textarea>", f.noCloneChecked = !!ut.cloneNode(!0).lastChild.defaultValue;
    ...
    function bt(t, e, n, i, r, o) {
        var s, a;
        if ("object" == typeof e) {
            for (a in "string" != typeof n && (i = i || n, n = void 0), e) bt(t, a, n, i, e[a], o);
            return t
        }
    ...
    v.event = {
        ...
        add: function(t, e, n, i, r) {
            var o, s, a, l, c, u, h, p, d, f, g, m = V.get(t);
            if (m)
                for (n.handler && (n = (o = n).handler, r = o.selector), r && v.find.matchesSelector(ft, r), n.guid || (n.guid = v.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(e) {
                        return void 0 !== v && v.event.triggered !== e.type ? v.event.dispatch.apply(t, arguments) : void 0
                    }), c = (e = (e || "").match(z) || [""]).length; c--;) d = g = (a = vt.exec(e[c]) || [])[1], f = (a[2] || "").split(".").sort(), d && (h = v.event.special[d] || {}, d = (r ? h.delegateType : h.bindType) || d, h = v.event.special[d] || {}, u = v.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, o), (p = l[d]) || ((p = l[d] = []).delegateCount = 0, h.setup && !1 !== h.setup.call(t, i, f, s) || t.addEventListener && t.addEventListener(d, s)), h.add && (h.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, u) : p.push(u), v.event.global[d] = !0)
        },
        remove: function(t, e, n, i, r) {
            var o, s, a, l, c, u, h, p, d, f, g, m = V.hasData(t) && V.get(t);
            if (m && (l = m.events)) {
                for (c = (e = (e || "").match(z) || [""]).length; c--;)
                    if (d = g = (a = vt.exec(e[c]) || [])[1], f = (a[2] || "").split(".").sort(), d) {
                        for (h = v.event.special[d] || {}, p = l[d = (i ? h.delegateType : h.bindType) || d] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) u = p[o], !r && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(o, 1), u.selector && p.delegateCount--, h.remove && h.remove.call(t, u));
                        s && !p.length && (h.teardown && !1 !== h.teardown.call(t, f, m.handle) || v.removeEvent(t, d, m.handle), delete l[d])
                    } else
        ...
        dispatch: function(t) {
            var e, n, i, r, o, s, a = v.event.fix(t),
            ...
            if (l && c.nodeType && !("click" === t.type && 1 <= t.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                        for (o = [], s = {}, n = 0; n < l; n++) void 0 === s[r = (i = e[n]).selector + " "] && (s[r] = i.needsContext ? -1 < v(r, this).index(c) : v.find(r, this, null, [c]).length), s[r] && o.push(i);
                        o.length && a.push({
                            elem: c,
                            handlers: o
                        })
    ...
    function jt(t, e) {
        var n, i, r, o, s, a, l, c;
        if (1 === e.nodeType) {
            if (V.hasData(t) && (o = V.access(t), s = V.set(e, o), c = o.events))
    ...
    function Nt(t, e, n, i) {
        ...
        var r, o, a, l, c, u, h = 0,
            ...
            m = e[0],
            y = v.isFunction(m);
        if (y || 1 < p && "string" == typeof m && !f.checkClone && Tt.test(m)) return t.each(function(r) {
            var o = t.eq(r);
            y && (e[0] = m.call(this, r, o.html())), Nt(o, e, n, i)
        });
        if (p && (o = (r = dt(e, t[0].ownerDocument, !1, t, i)).firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
            for (l = (a = v.map(lt(r, "script"), St)).length; h < p; h++) c = r, h !== d && (c = v.clone(c, !0, !0), l && v.merge(a, lt(c, "script"))), n.call(t[h], c, h);
            if (l)
                for (u = a[a.length - 1].ownerDocument, v.map(a, Dt), h = 0; h < l; h++) c = a[h], st.test(c.type || "") && !V.access(c, "globalEval") && v.contains(u, c) && (c.src ? v._evalUrl && v._evalUrl(c.src) : g(c.textContent.replace($t, ""), u))
        }
        return t
    }

    function At(t, e, n) {
        for (var i, r = e ? v.filter(e, t) : t, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || v.cleanData(lt(i)), i.parentNode && (n && v.contains(i.ownerDocument, i) && ct(lt(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    v.extend({
        ...
        clone: function(t, e, n) {
            var i, r, o, s, a, l, c, u = t.cloneNode(!0),
                h = v.contains(t.ownerDocument, t);
            if (!(f.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || v.isXMLDoc(t)))
                for (s = lt(u), i = 0, r = (o = lt(t)).length; i < r; i++) a = o[i], l = s[i], "input" === (c = l.nodeName.toLowerCase()) && rt.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e)
                if (n)
                    for (o = o || lt(t), s = s || lt(u), i = 0, r = o.length; i < r; i++) jt(o[i], s[i]);
                else jt(t, u);
            return 0 < (s = lt(u, "script")).length && ct(s, !h && lt(t, "script")), u
        },
        ...
        v.fn[t] = function(t) {
            for (var n, i = [], r = v(t), o = r.length - 1, s = 0; s <= o; s++) n = s === o ? this : this.clone(!0), v(r[s])[e](n), a.apply(i, n.get());
    ...
    function Ht(t, e, n) {
        ...
        return (n = n || zt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || v.contains(t.ownerDocument, t) || (s = v.style(t, e)), !f.pixelMarginRight() && qt.test(s) && Lt.test(e) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function Ft(t, e) {
        ...
        function e() {
            if (l) {
                ...
                n = "1%" !== e.top, s = "2px" === e.marginLeft, r = "4px" === e.width, l.style.marginRight = "50%", o = "4px" === e.marginRight, ft.removeChild(a), l = null
            }
        }
    ...
    var Ot = /^(none|table(?!-c[ea]).+)/,
        ...
        It = ["Webkit", "Moz", "ms"],
        Rt = i.createElement("div").style;

    function Wt(t) {
        if (t in Rt) return t;
        for (var e = t[0].toUpperCase() + t.slice(1), n = It.length; n--;)
            if ((t = It[n] + e) in Rt) return t
    }
    ...
    function Vt(t, e, n, i, r) {
        var o, s = 0;
        for (o = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; o < 4; o += 2) "margin" === n && (s += v.css(t, n + J[o], !0, r)), i ? ("content" === n && (s -= v.css(t, "padding" + J[o], !0, r)), "margin" !== n && (s -= v.css(t, "border" + J[o] + "Width", !0, r))) : (s += v.css(t, "padding" + J[o], !0, r), "padding" !== n && (s += v.css(t, "border" + J[o] + "Width", !0, r)));
        return s
    }
    ...
    function Xt(t, e, n) {
        ...
        if (t.getClientRects().length && (i = t.getBoundingClientRect()[e]), i <= 0 || null == i) {
            if (((i = Ht(t, e, o)) < 0 || null == i) && (i = t.style[e]), qt.test(i)) return i;
            r = s && (f.boxSizingReliable() || i === t.style[e]), i = parseFloat(i) || 0
        }
        return i + Vt(t, e, n || (s ? "border" : "content"), r, o) + "px"
    }

    function Ut(t, e, n, i, r) {
        return new Ut.prototype.init(t, e, n, i, r)
    }
    v.extend({
        cssHooks: {
            opacity: {
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var r, o, s, a = v.camelCase(e),
                    l = t.style;
                return e = v.cssProps[a] || (v.cssProps[a] = Wt(a) || a), s = v.cssHooks[e] || v.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (r = s.get(t, !1, i)) ? r : l[e] : ("string" == (o = typeof n) && (r = Z.exec(n)) && r[1] && (n = et(t, e, r), o = "number"), void(null != n && n == n && ("number" === o && (n += r && r[3] || (v.cssNumber[a] ? "" : "px")), f.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l[e] = n))))
            }
        },
        css: function(t, e, n, i) {
            var r, o, s, a = v.camelCase(e);
            return e = v.cssProps[a] || (v.cssProps[a] = Wt(a) || a), (s = v.cssHooks[e] || v.cssHooks[a]) && "get" in s && (r = s.get(t, !0, n)), void 0 === r && (r = Ht(t, e, i)), "normal" === r && e in Mt && (r = Mt[e]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), v.each(["height", "width"], function(t, e) {
        v.cssHooks[e] = {
            get: function(t, n, i) {
                if (n) return !Ot.test(v.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Xt(t, e, i) : tt(t, Pt, function() {
                    return Xt(t, e, i)
                })
            },
            set: function(t, n, i) {
                var r, o = i && zt(t),
                    s = i && Vt(t, e, i, "border-box" === v.css(t, "boxSizing", !1, o), o);
                return s && (r = Z.exec(n)) && "px" !== (r[3] || "px") && (t.style[e] = n, n = v.css(t, e)), Bt(0, n, s)
            }
        }
        ...
        }, Lt.test(t) || (v.cssHooks[t + e].set = Bt)
    }), v.fn.extend({
        css: function(t, e) {
            return R(this, function(t, e, n) {
                var i, r, o = {},
                    s = 0;
                if (v.isArray(e)) {
                    for (i = zt(t), r = e.length; s < r; s++) o[e[s]] = v.css(t, e[s], !1, i);
                    return o
                }
                return void 0 !== n ? v.style(t, e, n) : v.css(t, e)
            }, t, e, 1 < arguments.length)
        }
    }), ((v.Tween = Ut).prototype = {
        constructor: Ut,
    ...
    var Qt, Yt, Gt, Zt, Jt = /^(?:toggle|show|hide)$/,
        Kt = /queueHooks$/;
    ...
    function re(t, e, n) {
        var i, r, o = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var e = Qt || ee(), n = Math.max(0, c.startTime + c.duration - e), i = 1 - (n / c.duration || 0), o = 0, s = c.tweens.length; o < s; o++) c.tweens[o].run(i);
        ...
        for (function(t, e) {
            ...
            if (i = re.prefilters[o].call(c, t, u, c.opts)) return v.isFunction(i.stop) && (v._queueHooks(c.elem, c.opts.queue).stop = v.proxy(i.stop, i)), i;
        return v.map(u, ie, c), v.isFunction(c.opts.start) && c.opts.start.call(t, c), v.fx.timer(v.extend(l, {
            elem: t,
            anim: c,
            queue: c.opts.queue
    ...
    v.Animation = v.extend(re, {
        ...
        tweener: function(t, e) {
            ...
            for (var n, i = 0, r = t.length; i < r; i++) n = t[i], re.tweeners[n] = re.tweeners[n] || [], re.tweeners[n].unshift(e)
        },
        prefilters: [function(t, e, n) {
            ...
            for (i in n.queue || (null == (s = v._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function() {
                ...
                for (i in h && 1 === t.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (c = m && m.display) && (c = V.get(t, "display")), "none" === (u = v.css(t, "display")) && (c ? u = c : (it([t], !0), c = t.style.display || c, u = v.css(t, "display"), it([t]))), ("inline" === u || "inline-block" === u && null != c) && "none" === v.css(t, "float") && (l || (p.done(function() {
                        f.display = c
                    }), null == c && (u = f.display, c = "none" === u ? "" : u)), f.display = "inline-block")), n.overflow && (f.overflow = "hidden", p.always(function() {
                        f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
                    })), l = !1, d) l || (m ? "hidden" in m && (g = m.hidden) : m = V.access(t, "fxshow", {
                    display: c
                }), o && (m.hidden = !g), g && it([t], !0), p.done(function() {
                    for (i in g || it([t]), V.remove(t, "fxshow"), d) v.style(t, i, d[i])
                })), l = ie(g ? m[i] : 0, i, p), i in m || (m[i] = l.start, g && (l.end = l.start, l.start = 0))
        }],
        ...
        return v.fx.off || i.hidden ? r.duration = 0 : "number" != typeof r.duration && (r.duration in v.fx.speeds ? r.duration = v.fx.speeds[r.duration] : r.duration = v.fx.speeds._default), null != r.queue && !0 !== r.queue || (r.queue = "fx"), r.old = r.complete, r.complete = function() {
    ...
    }, Gt = i.createElement("input"), Zt = i.createElement("select").appendChild(i.createElement("option")), Gt.type = "checkbox", f.checkOn = "" !== Gt.value, f.optSelected = Zt.selected, (Gt = i.createElement("input")).value = "t", Gt.type = "radio", f.radioValue = "t" === Gt.value;
    var oe, se = v.expr.attrHandle;
    v.fn.extend({
        attr: function(t, e) {
            return R(this, v.attr, t, e, 1 < arguments.length)
        },
        ...
        attr: function(t, e, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === t.getAttribute ? v.prop(t, e, n) : (1 === o && v.isXMLDoc(t) || (r = v.attrHooks[e.toLowerCase()] || (v.expr.match.bool.test(e) ? oe : void 0)), void 0 !== n ? null === n ? void v.removeAttr(t, e) : r && "set" in r && void 0 !== (i = r.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : r && "get" in r && null !== (i = r.get(t, e)) ? i : null == (i = v.find.attr(t, e)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
    ...
    v.fn.extend({
        prop: function(t, e) {
            return R(this, v.prop, t, e, 1 < arguments.length)
        },
        ...
        addClass: function(t) {
            ...
            if ("string" == typeof t && t)
                for (e = t.match(z) || []; n = this[l++];)
                    if (r = ue(n), i = 1 === n.nodeType && " " + ce(r) + " ") {
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : v.isFunction(t) ? this.each(function(n) {
                ...
                var e, i, r, o;
                if ("string" === n)
                    for (i = 0, r = v(this), o = t.match(z) || []; e = o[i++];) r.hasClass(e) ? r.removeClass(e) : r.addClass(e);
                else void 0 !== t && "boolean" !== n || ((e = ue(this)) && V.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : V.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++];)
                if (1 === n.nodeType && -1 < (" " + ce(ue(n)) + " ").indexOf(e)) return !0;
            return !1
        }
    });
    var he = /\r/g;
    v.fn.extend({
        ...
        valHooks: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var n, i, r = t.options, o = v.makeArray(e), s = r.length; s--;)((i = r[s]).selected = -1 < v.inArray(v.valHooks.option.get(i), o)) && (n = !0);
        ...
        v.valHooks[this] = {
            set: function(t, e) {
                if (v.isArray(e)) return t.checked = -1 < v.inArray(v(t).val(), e)
            }
    ...
    v.extend(v.event, {
        trigger: function(e, n, r, o) {
            var s, a, l, c, u, p, d, f = [r || i],
                g = h.call(e, "type") ? e.type : e,
                m = h.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = l = r = r || i, 3 !== r.nodeType && 8 !== r.nodeType && !pe.test(g + v.event.triggered) && (-1 < g.indexOf(".") && (g = (m = g.split(".")).shift(), m.sort()), u = g.indexOf(":") < 0 && "on" + g, (e = e[v.expando] ? e : new v.Event(g, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = m.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), n = null == n ? [e] : v.makeArray(n, [e]), d = v.event.special[g] || {}, o || !d.trigger || !1 !== d.trigger.apply(r, n))) {
                if (!o && !d.noBubble && !v.isWindow(r)) {
                    for (c = d.delegateType || g, pe.test(c + g) || (a = a.parentNode); a; a = a.parentNode) f.push(a), l = a;
                    l === (r.ownerDocument || i) && f.push(l.defaultView || l.parentWindow || t)
                }
                for (s = 0;
                    (a = f[s++]) && !e.isPropagationStopped();) e.type = 1 < s ? c : d.bindType || g, (p = (V.get(a, "events") || {})[e.type] && V.get(a, "handle")) && p.apply(a, n), (p = u && a[u]) && p.apply && W(a) && (e.result = p.apply(a, n), !1 === e.result && e.preventDefault());
                return e.type = g, o || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(f.pop(), n) || !W(r) || u && v.isFunction(r[g]) && !v.isWindow(r) && ((l = r[u]) && (r[u] = null), r[v.event.triggered = g](), v.event.triggered = void 0, l && (r[u] = l)), e.result
            }
        },
    ...
    function xe(t, e, n, i) {
        ...
        if (v.isArray(e)) v.each(e, function(e, r) {
            n || me.test(t) ? i(t, r) : xe(t + "[" + ("object" == typeof r && null != r ? e : "") + "]", r, n, i)
        });
    ...
    v.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !v(this).is(":disabled") && we.test(this.nodeName) && !ye.test(t) && (this.checked || !rt.test(t))
            }).map(function(t, e) {
                var n = v(this).val();
    ...
    je.href = de.href, v.extend({
        ...
        ajaxSetup: function(t, e) {
            return e ? Le(Le(t, v.ajaxSettings), e) : Le(v.ajaxSettings, t)
        },
        ajaxPrefilter: Ne(Ee),
        ajaxTransport: Ne(Se),
        ajax: function(e, n) {
            "object" == typeof e && (n = e, e = void 0), n = n || {};
            var r, o, s, a, l, c, u, h, p, d, f = v.ajaxSetup({}, n),
                g = f.context || f,
            ...
            if (y.promise(T), f.url = ((e || f.url || de.href) + "").replace($e, de.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(z) || [""], null == f.crossDomain) {
                c = i.createElement("a");
                try {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = v.param(f.data, f.traditional)), Ae(Ee, f, n, T), u) return T;
            for (p in (h = v.event && f.global) && 0 == v.active++ && v.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !ke.test(f.type), o = f.url.replace(_e, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(be, "+")) : (d = f.url.slice(o.length), f.data && (o += (ge.test(o) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (o = o.replace(Ce, "$1"), d = (ge.test(o) ? "&" : "?") + "_=" + fe++ + d), f.url = o + d), f.ifModified && (v.lastModified[o] && T.setRequestHeader("If-Modified-Since", v.lastModified[o]), v.etag[o] && T.setRequestHeader("If-None-Match", v.etag[o])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && T.setRequestHeader("Content-Type", f.contentType), T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + De + "; q=0.01" : "") : f.accepts["*"]), f.headers) T.setRequestHeader(p, f.headers[p]);
            if (f.beforeSend && (!1 === f.beforeSend.call(g, T, f) || u)) return T.abort();
            if (C = "abort", w.add(f.complete), T.done(f.success), T.fail(f.error), r = Ae(Se, f, n, T)) {
            ...
            function k(e, n, i, a) {
                var c, p, d, b, _, C = n;
                u || (u = !0, l && t.clearTimeout(l), r = void 0, s = a || "", T.readyState = 0 < e ? 4 : 0, c = 200 <= e && e < 300 || 304 === e, i && (b = function(t, e, n) {
                ...
                }(f, b, T, c), c ? (f.ifModified && ((_ = T.getResponseHeader("Last-Modified")) && (v.lastModified[o] = _), (_ = T.getResponseHeader("etag")) && (v.etag[o] = _)), 204 === e || "HEAD" === f.type ? C = "nocontent" : 304 === e ? C = "notmodified" : (C = b.state, p = b.data, c = !(d = b.error))) : (d = C, !e && C || (C = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (n || C) + "", c ? y.resolveWith(g, [p, C, T]) : y.rejectWith(g, [T, C, d]), T.statusCode(x), x = void 0, h && m.trigger(c ? "ajaxSuccess" : "ajaxError", [T, f, c ? p : d]), w.fireWith(g, [T, C]), h && (m.trigger("ajaxComplete", [T, f]), --v.active || v.event.trigger("ajaxStop")))
            }
            return T
        },
    ...
    var qe = {
        ...
        ze = v.ajaxSettings.xhr();
    f.cors = !!ze && "withCredentials" in ze, f.ajax = ze = !!ze, v.ajaxTransport(function(e) {
        var n, i;
        if (f.cors || ze && !e.crossDomain) return {
            send: function(r, o) {
                ...
                n = function(t) {
                    return function() {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(qe[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                            binary: a.response
                        } : {
                            text: a.responseText
    ...
    v.ajaxSetup({
        ...
        var r, o, s, a = !1 !== e.jsonp && (Oe.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Oe.test(e.data) && "data");
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = v.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Oe, "$1" + r) : !1 !== e.jsonp && (e.url += (ge.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
            return s || v.error(r + " was not called"), s[0]
        }, e.dataTypes[0] = "json", o = t[r], t[r] = function() {
            s = arguments
        }, i.always(function() {
            void 0 === o ? v(t).removeProp(r) : t[r] = o, e[r] && (e.jsonpCallback = n.jsonpCallback, Fe.push(r)), s && v.isFunction(o) && o(s[0]), s = o = void 0
        }), "script"
    }), f.createHTMLDocument = ((He = i.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === He.childNodes.length), v.parseHTML = function(t, e, n) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (f.createHTMLDocument ? ((r = (e = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href, e.head.appendChild(r)) : e = i), s = !n && [], (o = E.exec(t)) ? [e.createElement(o[1])] : (o = dt([t], e, s), s && s.length && v(s).remove(), v.merge([], o.childNodes)));
        var r, o, s
    }, v.fn.load = function(t, e, n) {
        var i, r, o, s = this,
            a = t.indexOf(" ");
        return -1 < a && (i = ce(t.slice(a)), t = t.slice(0, a)), v.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (r = "POST"), 0 < s.length && v.ajax({
            url: t,
            type: r || "GET",
            dataType: "html",
            data: e
        ...
        setOffset: function(t, e, n) {
            var i, r, o, s, a, l, c = v.css(t, "position"),
                u = v(t),
                h = {};
            "static" === c && (t.style.position = "relative"), a = u.offset(), o = v.css(t, "top"), l = v.css(t, "left"), ("absolute" === c || "fixed" === c) && -1 < (o + l).indexOf("auto") ? (s = (i = u.position()).top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), v.isFunction(e) && (e = e.call(t, n, v.extend({}, a))), null != e.top && (h.top = e.top - a.top + s), null != e.left && (h.left = e.left - a.left + r), "using" in e ? e.using.call(t, h) : u.css(h)
        }
    }, v.fn.extend({
        offset: function(t) {
            ...
            return o ? o.getClientRects().length ? (i = o.getBoundingClientRect()).width || i.height ? (n = Pe(r = o.ownerDocument), e = r.documentElement, {
        ...
        v.cssHooks[e] = Ft(f.pixelPosition, function(t, n) {
        ...
        v.each({
            ...
            v.fn[i] = function(r, o) {
                ...
                return R(this, function(e, n, r) {
                    var o;
                    return v.isWindow(e) ? 0 === i.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === r ? v.css(e, n, a) : v.style(e, n, r, a)
                }, e, s ? r : void 0, s)
            }
        })
    }), v.fn.extend({
    ...
    return v.noConflict = function(e) {
        return t.$ === v && (t.$ = Ie), e && t.jQuery === v && (t.jQuery = Me), v
    }, e || (t.jQuery = t.$ = v), v
}),
function(t, e, n, i) {
    function r(e, n) {
    ...
    r.Defaults = {
        ...
        run: function() {
            var e = [],
                ...
                a = "",
                l = "";
            for (s /= 2; 0 < s;) e.push(this.normalize(e.length / 2, !0)), a += n[e[e.length - 1]][0].outerHTML, e.push(this.normalize(n.length - 1 - (e.length - 1) / 2, !0)), l = n[e[e.length - 1]][0].outerHTML + l, s -= 1;
        ...
        for (var e = 0, n = this._pipe.length, i = t.proxy(function(t) {
                return this[t]
            }, this._invalidated), r = {}; e < n;)(this._invalidated.all || 0 < t.grep(this._pipe[e].filter, i).length) && this._pipe[e].run(r), e++;
        ...
        return this.settings.freeDrag || t.each(s, t.proxy(function(t, a) {
            return "left" === n && a - 30 < e && e < a + 30 ? r = t : "right" === n && a - o - 30 < e && e < a - o + 30 ? r = t + 1 : this.op(e, "<", a) && this.op(e, ">", s[t + 1] !== i ? s[t + 1] : a - o) && (r = "left" === n ? t + 1 : t), -1 === r
        ...
        return !this.isNumeric(t) || n < 1 ? t = i : (t < 0 || n + r <= t) && (t = ((t - r / 2) % n + n) % n + r / 2), t
        ...
        if (e.type === r.Type.Event) {
            if (t.event.special[e.name] || (t.event.special[e.name] = {}), !t.event.special[e.name].owl) {
                ...
                t.event.special[e.name]._default = function(t) {
                    return !n || !n.apply || t.namespace && -1 !== t.namespace.indexOf("owl") ? t.namespace && -1 < t.namespace.indexOf("owl") : n.apply(this, arguments)
...
function(t, e, n, i) {
        ...
        this._core = e, this._loaded = [], this._handlers = {
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": t.proxy(function(e) {
                if (e.namespace && this._core.settings && this._core.settings.lazyLoad && (e.property && "position" == e.property.name || "initialized" == e.type)) {
                    ...
                    for (0 < n.lazyLoadEager && (i += n.lazyLoadEager, n.loop && (o -= n.lazyLoadEager, i++)); r++ < i;) this.load(s / 2 + this._core.relative(o)), s && t.each(this._core.clones(this._core.relative(o)), a), o++
                }
            }, this)
        }, this._core.options = t.extend({}, r.Defaults, this._core.options), this._core.$element.on(this._handlers)
    };
    r.Defaults = {
        ...
        var i = this._core.$stage.children().eq(n),
            r = i && i.find(".owl-lazy");
        !r || -1 < t.inArray(i.get(0), this._loaded) || (r.each(t.proxy(function(n, i) {
            var r, o = t(i),
                s = 1 < e.devicePixelRatio && o.attr("data-src-retina") || o.attr("data-src") || o.attr("data-srcset");
...
function(t, e, n, i) {
    ...
    r.Defaults = {
        ...
        var e, n = this._core.settings,
            ...
            o = n.loop || n.rewind;
        this._controls.$relative.toggleClass("disabled", !n.nav || i), n.nav && (this._controls.$previous.toggleClass("disabled", !o && r <= this._core.minimum(!0)), this._controls.$next.toggleClass("disabled", !o && r >= this._core.maximum(!0))), this._controls.$absolute.toggleClass("disabled", !n.dots || i), n.dots && (e = this._pages.length - this._controls.$absolute.children().length, n.dotsData && 0 !== e ? this._controls.$absolute.html(this._templates.join("")) : 0 < e ? this._controls.$absolute.append(new Array(e + 1).join(this._templates[0])) : e < 0 && this._controls.$absolute.children().slice(e).remove(), this._controls.$absolute.find(".active").removeClass("active"), this._controls.$absolute.children().eq(t.inArray(this.current(), this._pages)).addClass("active"))
...
function(t) {
    ...
    function r(o, a) {
        function c(t) {
            ...
            var e = (U = t) / F,
                i = e * P;
            1 < e && (i += (Math.ceil(e) - 1) * I), g(a.ratedFill), (i = a.rtl ? 100 - i : i) < 0 ? i = 0 : 100 < i && (i = 100), V.css("width", i + "%")
        }

        function h() {
            R = O * a.numStars + M * (a.numStars - 1), P = O / R * 100, I = M / R * 100, o.width(R), c()
        }

        function p(t) {
            var e = a.starWidth = t;
            return O = window.parseFloat(a.starWidth.replace("px", "")), B.find("svg").attr({
                width: a.starWidth,
                height: e
            }), V.find("svg").attr({
                width: a.starWidth,
        ...
        function d(t) {
            return a.spacing = t, M = parseFloat(a.spacing.replace("px", "")), B.find("svg:not(:first-child)").css({
                "margin-left": t
        ...
        function f(t) {
            return a.normalFill = t, (a.rtl ? V : B).find("svg").attr({
                fill: a.normalFill
            }), o
        }
        ...
        function g(t) {
            if (a.multiColor) {
                var e = (U - X) / a.maxValue * 100,
                    r = a.multiColor || {};
                t = function(t, e, r) {
                    if (!t || !e) return null;
                    r = n(r) ? r : 0, t = u(t), e = u(e);
                    var o = i(t.r, e.r, r),
                        s = i(t.b, e.b, r);
                    return "#" + o + i(t.g, e.g, r) + s
                }(r.startColor || l.startColor, r.endColor || l.endColor, e)
            } else Y = t;
            return a.ratedFill = t, (a.rtl ? B : V).find("svg").attr({
                fill: a.ratedFill
            }), o
        }

        function m(t) {
            t = !!t, a.rtl = t, f(a.normalFill), c()
        }
        ...
        function y(e) {
            a.numStars = e, F = a.maxValue / a.numStars, B.empty(), V.empty();
            for (var n = 0; n < a.numStars; n++) B.append(t(a.starSvg || s)), V.append(t(a.starSvg || s));
            return p(a.starWidth), f(a.normalFill), d(a.spacing), c(), o
        }

        function w(t) {
            return a.maxValue = t, F = a.maxValue / a.numStars, a.rating > t && k(t), c(), o
        }

        function x(t) {
            return a.precision = t, k(a.rating), o
        }

        function b(t) {
            return a.halfStar = t, o
        }

        function _(t) {
            return a.fullStar = t, o
        }

        function C(t) {
            var e, n, i, r, o, s = B.offset().left,
                l = s + B.width(),
                c = a.maxValue,
                u = t.pageX,
                h = 0;
            if (u < s) h = X;
                ...
                var p = (u - s) / (l - s);
                if (0 < M)
                    for (var d = p *= 100; 0 < d;) P < d ? (h += F, d -= P + I) : (h += d / P * F, d = 0);
                else h = p * a.maxValue;
                n = (e = h) % F, i = F / 2, r = a.halfStar, ((o = a.fullStar) || r) && (o || r && i < n ? e += F - n : (e -= n, 0 < n && (e += i))), h = e
            }
            return a.rtl && (h = c - h), parseFloat(h)
        }

        function T(t) {
            return a.readOnly = t, o.attr("readonly", !0), z(), t || (o.removeAttr("readonly"), o.on("mousemove", D).on("mouseenter", D).on("mouseleave", j).on("click", N).on("rateyo.init", A).on("rateyo.change", L).on("rateyo.set", q)), o
        }

        function k(t) {
            var n = t,
                i = a.maxValue;
            return "string" == typeof n && ("%" === n[n.length - 1] && (n = n.substr(0, n.length - 1), w(i = 100)), n = parseFloat(n)),
                function(t, e, r) {
                    if (!(X <= n && n <= i)) throw Error("Invalid Rating, expected value between " + X + " and " + i)
                }(), n = parseFloat(n.toFixed(a.precision)), e(parseFloat(n), X, i), a.rating = n, c(), Q && o.trigger("rateyo.set", {
                    rating: n
                }), o
        }
        ...
        function S(t) {
            return a.onChange = t, o
        }

        function D(t) {
            var n = C(t).toFixed(a.precision),
                i = a.maxValue;
            c(n = e(parseFloat(n), X, i)), o.trigger("rateyo.change", {
                rating: n
            })
        }
        ...
        function j() {
            var t, e;
            e = !1, t = navigator.userAgent || navigator.vendor || window.opera, (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(t) || /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(t.substr(0, 4))) && (e = !0), e || (c(), o.trigger("rateyo.change", {
                rating: a.rating
            }))
        }

        function N(t) {
            var e = C(t).toFixed(a.precision);
            e = parseFloat(e), H.rating(e)
        }

        function A(t, e) {
            a.onInit && "function" == typeof a.onInit && a.onInit.apply(this, [e.rating, H])
        }

        function L(t, e) {
            a.onChange && "function" == typeof a.onChange && a.onChange.apply(this, [e.rating, H])
        }

        function q(t, e) {
            a.onSet && "function" == typeof a.onSet && a.onSet.apply(this, [e.rating, H])
        }

        function z() {
            o.off("mousemove", D).off("mouseenter", D).off("mouseleave", j).off("click", N).off("rateyo.init", A).off("rateyo.change", L).off("rateyo.set", q)
        }
        this.node = o.get(0);
        var H = this;
        o.empty().addClass("jq-ry-container");
        var F, O, P, M, I, R, W = t("<div/>").addClass("jq-ry-group-wrapper").appendTo(o),
            B = t("<div/>").addClass("jq-ry-normal-group").addClass("jq-ry-group").appendTo(W),
            V = t("<div/>").addClass("jq-ry-rated-group").addClass("jq-ry-group").appendTo(W),
            X = 0,
            U = a.rating,
            Q = !1,
            Y = a.ratedFill;
        this.rating = function(t) {
            return n(t) ? (k(t), o) : a.rating
        }, this.destroy = function() {
            return a.readOnly || z(), r.prototype.collection = (e = o.get(0), n = this.collection, t.each(n, function(t) {
                if (e === this.node) {
                    var i = n.slice(0, t),
                        r = n.slice(t + 1, n.length);
                    return n = i.concat(r), !1
                }
            }), n), o.removeClass("jq-ry-container").children().remove(), o;
            var e, n
            ...
            return n(e) ? i(e) : a[t]
        }, y(a.numStars), T(a.readOnly), a.rtl && m(a.rtl), this.collection.push(this), this.rating(a.rating, !0), Q = !0, o.trigger("rateyo.init", {
            rating: a.rating
        })
    }
    ...
    var s = '<?xml version="1.0" encoding="utf-8"?><svg version="1.1"xmlns="http://www.w3.org/2000/svg"viewBox="0 12.705 512 486.59"x="0px" y="0px"xml:space="preserve"><polygon points="256.814,12.705 317.205,198.566 512.631,198.566 354.529,313.435 414.918,499.295 256.814,384.427 98.713,499.295 159.102,313.435 1,198.566 196.426,198.566 "/></svg>',
        a = {
            starWidth: "32px",
            normalFill: "gray",
            ratedFill: "#f39c12",
    ...
    r.prototype.collection = [], window.RateYo = r, t.fn.rateYo = function() {
        return function(e) {
            ...
            if (0 === s.length) e = s[0] = {};
                ...
                if (1 !== s.length || "object" != typeof s[0]) {
                    if (1 <= s.length && "string" == typeof s[0]) {
                        ...
                        return t.each(i, function(t, e) {
                            ...
                            var r = i[l];
                            if (!r) throw Error("Method " + l + " does not exist!");
                            var s = r.apply(i, c);
                            u.push(s)
                        }), u = 1 === u.length ? u[0] : u
                    }
            ...
            return e = t.extend({}, a, e), t.each(i, function() {
                var i = o(this, n);
                if (i) return i;
                var s = t(this),
                    a = {},
                    l = t.extend({}, e);
                return t.each(s.data(), function(t, e) {
    ...
    $(".header.media #menu").click(function(t) {
        t.preventDefault(), $(".menu.media").css({
            display: "block"
        }), $(".menu.media a").click(function(t) {
            var e = $(this).attr("href");
            document.location.href = e
        }), $("a.exit").on("click", function(t) {
            t.preventDefault(), $(".menu.media").css({
                display: "none"
            })
        }), $(".menu.media").on("click", function(t) {
            t.preventDefault(), $(".menu.media").css({
                display: "none"
            })
        })
    }), $(".menu .links a.hasHover").hover(function() {
        $(".hover").toggleClass("visible").mouseenter(function() {
            $(this).css({
                display: "block"
            })
        }).mouseleave(function() {
    ...
    var t = $(".reviews .owl-carousel"),
        e = $(".like .owl-carousel"),
        n = $(".press-release .owl-carousel");

    function i(t) {
        var e = t.item.count,
            n = (t.item.count, t.item.index + 1);
        1 != n ? $(".owl-prev").removeClass("disabled") : $(".owl-prev").addClass("disabled"), n + 2 == e ? $(".owl-next").addClass("disabled") : $(".owl-next").removeClass("disabled")
    }
    t.owlCarousel({
        margin: 75,
        loop: !1,
    ...
    }), $(".reviews .owl-prev").click(function(e) {
        t.trigger("prev.owl.carousel", [300])
    }), $(".reviews .owl-next").click(function(e) {
        t.trigger("next.owl.carousel", [300])
    }), $(".like .owl-prev").click(function(t) {
        e.trigger("prev.owl.carousel", [300])
    }), $(".like .owl-next").click(function(t) {
        e.trigger("next.owl.carousel", [300])
    }), $(".press-release .owl-prev").click(function(t) {
        n.trigger("prev.owl.carousel", [300])
    }), $(".press-release .owl-next").click(function(t) {
        n.trigger("next.owl.carousel", [300])
    }), $(".header.big").next().is(".breadcrumbs") && $(".header.big").css({
        marginBottom: 0
    }), $("#count").next().is("#resetCount") && $("#resetCount").click(function() {
        $("#count").val(1)
    }), $(".product_menu li a").click(function(t) {
        t.preventDefault();
        var e = $(this).attr("href");
        document.location.href = e
    }), $(".pagination ul li").click(function(t) {
        !$(this).is(".prev") && $(this).is(".next")
    }), $(".pagination ul li.prev").click(function(t) {
        var e = $(".pagination ul li.prev a").attr("href");
        if (null == e) return !1;
        document.location.href = e
    }), $(".pagination ul li.next").click(function(t) {
        var e = $(".pagination ul li.next a").attr("href");
        if (null == e) return !1;
        document.location.href = e
    });
    var r = $(".foto").find(".foto_wrap.active img").attr("src");
    $(".foto .big img").attr("src", r), $(".foto .small .foto_wrap img").click(function() {
        $(".foto").find(".foto_wrap.active").removeClass("active"), $(this).parent().addClass("active");
        var t = $(".foto").find(".foto_wrap.active img").attr("src");
        $(".foto .big img").attr("src", t)
    }), $(".form_wrap input").click(function() {
        $(this).parent().parent().find(".form_wrap.active").removeClass("active"), $(this).parent().addClass("active")
    }), $(".tabs .tabs_head div").click(function(t) {
        var e = $(this).attr("data-content");
        $(this).parent().find("div.active").removeClass("active"), $(this).addClass("active"), $(".tabs .tabs_content").find("div.watch").removeClass("watch"), $(".tabs .tabs_content #" + e).addClass("watch")
    }), $(".product_more .videos .videos_item").click(function() {
        $(this).parent().find(".videos_item.active").removeClass("active"), $(this).addClass("active")
    }), $("section.video .video_wrap .iframe_wrap").click(function() {
        $(this).parent().parent().find(".iframe_wrap.active").removeClass("active"), $(this).addClass("active")
    })
});
